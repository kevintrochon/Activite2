package nc.unc.kevin.trochon.calcul;

/**
 * Classe utilitaire de calcul sur des entiers.
 */
public class CalculUtils {
  ...
  /**
   * Procède à la division que si le dénominateur est supérieure 10
   * sinon je retourne.
   *
   ...
   * @return numerateur / denominateur si denominateur est différent 0
   * @throw IllegalArgumentException si denominateur est egale 0
   */
